...
export const countryStatisticsSchema = z
  .object({
    country: z.string(),
...
export const yearlyDaysAbroadSchema = z
  .object({
...
export const travelStreakSchema = z
  .object({
...
export const milestoneInfoSchema = z
  .object({
...
export const safeTravelBudgetSchema = z
  .object({
...
export const travelProjectionSchema = z
  .object({
...
export const tripRiskAssessmentSchema = z
  .object({
    tripId: z.string(),
...
export const annualTravelSummarySchema = z
  .object({
    year: z.number().int(),

...
export const yearBoundariesSchema = z
  .object({
    yearStart: z.date(),
    yearEnd: z.date(),
  })
...
export const presenceStreakSchema = z
  .object({
    startDate: z.string(),
    endDate: z.string(),
...
export const travelRiskResultSchema = z
  .object({
...
export const travelBudgetRiskResultSchema = z
  .object({

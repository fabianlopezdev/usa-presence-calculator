...
export const RemovalOfConditionsStatusSchema = z
  .object({
    applies: z.boolean(),
...
export const GreenCardRenewalStatusSchema = z
  .object({
...
export const SelectiveServiceStatusSchema = z
  .object({
    applies: z.boolean(),
...
export const TaxReminderStatusSchema = z
  .object({
...
export const ComprehensiveComplianceStatusSchema = z
  .object({
...
export const ComplianceCalculationParamsSchema = z
  .object({
